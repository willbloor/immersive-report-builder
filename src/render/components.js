  ...
  return `
    <div class="component-toolbar no-print">
      ...
      <button
        ...
        title="${pendingDelete ? "Confirm component deletion" : "Delete component"}"
      >
        ${pendingDelete ? "Confirm" : "Del"}
      </button>
      <button class="mini-btn" type="button" data-action="open-inspector" title="Open inspector">INS</button>
